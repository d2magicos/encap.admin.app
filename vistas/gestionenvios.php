    ...
    <div class="panel panel-default" style="border-color: #666; border-width: 3px; border-style: double;">
      <div class="panel-heading">
        <div class="box-header with-border">
            <h1 class="box-title">Administrar Gestion de Envios</h1>
   ...
   <div class="panel-body table-responsive" class="box-body" id="listadoregistros">
        <table id="tbllistado" class="table table-striped table-bordered table-condensed table-hover" width="100%">
              <thead>
                ...
                <th>Departamento</th>
                <th>Ciudad</th>       
                <th style="color:red">Envio Fisico</th>
                <th >Estado</th>
                <th style="color:red">Impresion</th>
                <th >Cliente Contactado</th>
                <th >Observacion Contacto</th>
                <th style="color:red">Lugar de confirmación</th>
                <th>Accciones</th>
                <th>Botones de Impresiones</th>
                <th>Certificado</th>
                <th>Observaciones</th>
              </thead>
              <tbody>                            
...
<!--Fin-Contenido-->
      ...
      <div class="modal-dialog modal-lg" style="width: 1500px">
          ...
          <div class="modal-header panel-heading" style="background-color: #01324b">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                  <h4 class="modal-title text-center"><span >FORMULARIO </span> VISTA DE CONTACTO CON EL CLIENTE</h4>  
            </div>
              ...
              <div class="modal-body panel-body">
                  ...
                  <div class="form-group col-lg-4 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <div class="input-group">
                      ...
                      <input type="hidden" name="idcourier" id="idcourier" value="1">                     
              ...
              <div class="modal-header panel-heading" style="background-color: #01324b">
                  <h4 class="modal-title" ><span id="titulo-formulario">Datos</span> del cliente contactado</h4>  
            ...
            <div class="form-group col-sm-6 col-lg-12 " style="background: #fff ; padding:5px 5px" >
              <div class="row">                
                   <div class="form-group col-lg-4 col-md-8 col-sm-8 col-xs-12">
                  <label>Se contactó con el cliente:</label>
                  <div class="input-group" >    
                      <select class="form-control select-picker"  style="width:300px; height:35px" name="contacto_confirmacion" id="contacto_confirmacion"  >
                ...
                <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-12">
                  ...
                  <div class="input-group">
                    <textarea  style="width: 950px; height:48px" type="text" class="form-control" name="observaciones_contacto" id="observaciones_contacto" placeholder="Observaciones" maxlength="200">   </textarea>        
                  </div>
                </div> 
              </div>
            </div>
                ...
                <div class="modal-footer panel-footer">
                  <button class="btn btn-primary" type="submit" id="btnGuardar" style="font-size:18px" ><i class="fa fa-save"></i> Guardar</button> &nbsp
 ...
 <form id="formulario2" class="modal fade" method="POST">
      <div class="modal-dialog modal-lg" style="width: 1500px">
          ...
          <div class="modal-header panel-heading" style="background-color: #01324b">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                  <h4 class="modal-title text-center"><span >FORMULARIO </span> VISTA DE ENVIO POR CONFIRMAR LUGAR</h4>  
            </div>
              ...
              <div class="modal-body panel-body">
                  <input type="hidden" id="txtCodigoSeleccionado">                  
                    <div class="form-group col-lg-3">
                      <label class="col-form-label">Personal (*)</label>
                      <input type="hidden" name="idpersonal" id="idpersonal">  
                      <input type="text" class="form-control" name="nombrepersonal" id="nombrepersonal2" readonly>
                    </div>
                  ...
                  <div class="form-group col-lg-4 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-bookmark-o"></i></span>                
                      <input type="hidden" name="idmatricula" id="idmatricula2"> 
                      <input type="hidden" name="idenvio" id="idenvio2"> 
                      <input type="hidden" name="idcourier" id="idcourier2" value="1">                     

                      <input type="hidden" name="idpersonal" id="idpersonal2">   
                      <input style="color:red; width: 550px; height:34px" type="text" class="form-control" name="cod_matriculam" id="cod_matriculam2" maxlength="20" readonly >                        
                    </div>
                  </div>
                </div>
              ...
              <div class="form-group col-lg-12 col-md-3 col-sm-6 col-xs-12" style="background-color: #fff"><br>
                ...
                <div class="form-group col-lg-3 col-md-4 col-sm-4 col-xs-12">
                  ...
                  <div class="input-group" >                    
                    ...
                    <select style="height:34px" class="form-control select-picker" name="tipo_documentom" id="tipo_documentom2" >
                ...
                <div class="form-group col-lg-3 col-md-4 col-sm-4 col-xs-12">              
                  ...
                  <span class="input-group-addon"><i class="fa fa-instagram"></i></span>              
                    <input style="width: 300px; height:34px" type="text" class="form-control" name="num_documentom" id="num_documentom2"   readonly>
                 </div>
                </div>
                ...
                <div class="form-group col-lg-6 col-md-8 col-sm-8 col-xs-12">
                  ...
                  <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-users"></i></span>                 
                    <input style="width: 650px; height:34px" type="text" class="form-control" id="nombrem2" name="nombrem" readonly >                 
                  </div>
                </div>
                ...
                <div class="form-group col-lg-3 col-md-8 col-sm-8 col-xs-12">
                  ...
                  <div class="input-group" >      
                    <span class="input-group-addon" ><i class="fa fa-mobile"></i></span> 
                    <input type="text" class="form-control"  type="text" name="telefonom" id="telefonom2" maxlength="20" readonly >
                  </div>
                </div>
                ...
                <div class="form-group col-lg-3 col-md-8 col-sm-8 col-xs-12">
                  ...
                  <div class="input-group" >      
                    <span class="input-group-addon" ><i class="fa fa-mobile"></i></span> 
                    <input type="text" class="form-control"  type="text" name="telefono2m" id="telefono2m2" maxlength="20" readonly  >
                  </div>
                </div>
                ...
                <div class="form-group col-lg-3 col-md-4 col-sm-4 col-xs-12">
                  ...
                  <div class="input-group date">
                    ...
                    <input class="form-control"   type="email" name="emailm" id="emailm2" maxlength="80" readonly>
                  </div>
                </div>
                ...
                <div class="form-group col-lg-3 col-md-8 col-sm-8 col-xs-12">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="paism" id="paism2" maxlength="20" readonly>           
                  </div>
                </div>
                ...
                <div class="form-group col-lg-3 col-md-8 col-sm-8 col-xs-12">
                  ...
                  <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-map fa-fw"></i></span>   
                    <input type="text" class="form-control" name="departamentom" id="departamentom2" maxlength="50" readonly>           
                  </div>
                </div>
                ...
                <div class="form-group col-lg-3 col-md-8 col-sm-8 col-xs-12">
                  ...
                  <div class="input-group" >      
                    <span class="input-group-addon" ><i class="fa fa-map fa-fw"></i></span> 
                    <input type="text" class="form-control" name="ciudadm" id="ciudadm2"  maxlength="70" readonly>
                  </div>
                </div>           
                ...
                <div class="form-group col-lg-3 col-md-8 col-sm-8 col-xs-12">
                  ...
                  <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-map fa-fw"></i></span>   
                    <input type="text" class="form-control" name="direccionm" id="direccionm2" maxlength="300" readonly>           
                  </div>
                </div>
                ...
                <div class="form-group col-lg-3 col-md-8 col-sm-8 col-xs-12">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="fecha_cumplem" id="fecha_cumplem2" maxlength="20" readonly>           
                  </div>
                </div>  
              </div>

            <div class="modal-header panel-heading" style="background-color: #01324b">                
                  <h4 class="modal-title" ><span id="titulo-formulario2">Datos</span> del curso</h4>  
            </div> 

              <div class="form-group col-lg-12 col-md-3 col-sm-6 col-xs-12" style="background:  #fff"><br>
                <div class="form-group col-lg-12 col-md-12 col-xs-12">
                  <table id="detallesm2" class="table table-striped table-bordered table-condensed table-hover" width="100%">
                      <tbody>
            ...
            <div class="modal-header panel-heading" style="background-color: #e74c3c ">
                <h4 class="modal-title" style="color:#fff"><span id="titulo-formulario2">Detalles</span> del envio</h4>  
            </div>
            ...
            <div class="form-group col-sm-6 col-lg-12 " style="background: #fff ; padding:5px 5px" >
              <div class="row">                
                  ...
                  <div class="input-group" >    
                      <select class=" form-control select-picker"  style="width:300px; height:35px" name="lugar_confirmacion" id="lugar_confirmacion2" >
                        <?php $cont=1; ?>
                    ...
                    <option value="Abancay"><?php echo $cont++; ?> Abancay</option>
                      ...
                      <option value="Pichanaqui"><?php echo $cont++; ?> Pichanaqui</option>
                ...
                <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-12">
                  <label>Observaciones:</label>
                  <div class="input-group">
                    <textarea  style="width: 950px; height:48px" type="text" class="form-control" name="observaciones_envio" id="observaciones_envio2" placeholder="Observaciones" maxlength="200">   </textarea>        
                  </div>
                </div> 
              </div>
            </div>
                ...
                <div class="modal-footer panel-footer">
                  <button class="btn btn-primary" type="submit" id="btnGuardar2" style="font-size:18px" ><i class="fa fa-save"></i> Guardar y Actualizar Envio</button> &nbsp
                    <button type="button" class="btn btn-danger pull-left" data-dismiss="modal" style="font-size:18px" ><i class="fa fa-times"></i> Cancelar</button>
                </div>
           </div>
    </div>
...
?>
<script type="text/javascript" src="js/gestionenvios.js"></script>
<?php 
}
ob_end_flush();
?>
