...
?>
      ...
      <section class="content">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Administrar sub tipo cursos</li>
          </ol>
        </section>
        <div class="panel panel-default" style="border-color:#666; border-width: 3px; border-style: double;">
          <div class="panel-heading">
            <div class="box-header with-border">
              <h1 class="box-title"> Administrar sub tipo cursos </h1>
            </div>
          </div>

          <div class="panel-body table-responsive" class="box-body" id="listadoregistros">
            <button class="btn btn-primary" data-toggle="modal" data-target="#myModal" style="font-size:16px"><i class="fa fa-plus"> Crear Nuevo Sub Categoria (Cursos)</i>
            </button>
            <br><br>
        ...
        <div class="modal-content">
          ...
          <form class="form-horizontal" role="form" name="formulario" id="formulario" method="POST">
            ...
            <div class="modal-header" style="background:#151e38; color:white">
              ...
              <h4 class="modal-title; text-center">Formulario sub tipo Cursos</h4>
            </div>

            <div class="modal-body panel-body" style="padding: 20px; ">
              <div class="form-group">
                <label for="name" class="col-sm-3  control-label">Nombre sub tipo<spam style="color: #c0392b ; font-size: 18px">*</spam> :</label>
                <div class="col-sm-9">
  ...
  <script type="text/javascript" src="js/subtipocurso.js"></script>
<?php
}
ob_end_flush();
?>