...
<div class="content-wrapper">
  ...
  <section class="content-header">
            ...
            <ol class="breadcrumb">      
              ...
              <li class="active">Administrar empresas courier</li>    
            </ol>
        </section>
    <div class="panel panel-default" style="border-color: #666; border-width: 3px; border-style: double;">
      <div class="panel-heading">
        <div class="box-header with-border" >
            <h1 class="box-title" > Administrar empresas courier </h1>
      ...
      <div class="panel-body table-responsive" class="box-body" id="listadoregistros">
        <button class="btn btn-primary" data-toggle="modal" data-target="#myModal" style="font-size:18px"><i class="fa fa-plus"> Crear Nuevo Courier</i>
        </button>
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" role="form" name="formulario" id="formulario" method="POST">
        ...
        <div class="modal-header" style="background:#151e38; color:white">
          ...
          <h4 class="modal-title" style="text-align: center; font-size: 20px"  >Formulario de Tipo de Courier</h4>
        </div>

        <div class="modal-body">
          <div class="form-group">
            <label for="name" class="col-sm-3 control-label">Courier:</label>
            <div class="col-sm-9">
              <input type="hidden" name="idcourier" id="idcourier">
              <input type="text" class="form-control" name="nombre1" id="nombre1" maxlength="50" placeholder="Nombre del courier" required>
            </div>
          </div>
