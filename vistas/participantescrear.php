...
<!--Contenido-->
      ...
      <br>
        ...
        <div class="box-header with-border" >
            <h1 class="box-title"> Nuestros Participantes</h1>
      ...
      <div class="panel-body table-responsive" class="box-body" id="listadoregistros">
        <button class="btn btn-primary" data-toggle="modal" data-target="#myModal" style="font-size:18px"><i class="fa fa-plus"> Crear nuevo participante</i>
        </button>  
        <a href="matricula.php"><button class="btn btn-success" style="font-size:18px"><i class="fa fa-file"></i> Realizar nueva venta</button></a>       
        <br><br>
      ...
      <form class="form-horizontal" role="form" name="formulario" id="formulario" method="POST">
        ...
        <div class="modal-body"> 
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <select id="idpais" name="idpais" class="form-control selectpicker"  required></select>
...
?>
<script type="text/javascript" src="js/participantescrear.js"></script>
