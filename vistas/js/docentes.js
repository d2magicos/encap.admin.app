...
function init(){
	...
	$.post("../controladores/docentes.php?op=selectTipodocumento", function(r){
		$("#idtipo_documento").html(r);
		$('#idtipo_documento').selectpicker('refresh');
});

	//Cargamos los items al select pais
	$.post("../controladores/docentes.php?op=selectPais", function(r){
		$("#idpais").html(r);
...
function listar()
{
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax":
				{
					url: '../controladores/docentes.php?op=listarp',
					type : "get",
					dataType : "json",						
					error: function(e){
...
function guardaryeditar(e)
{
	...
	$.ajax({
		url: "../controladores/docentes.php?op=guardaryeditar",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
...
{
	$.post("../controladores/docentes.php?op=mostrar",{idpersona : idpersona}, function(data, status)
	{
...
function desactivar(idpersona)
{
	swal({
		...
		showLoaderOnConfirm: true
			...
			if (isConfirm){
				$.post("../controladores/docentes.php?op=desactivar", {idpersona : idpersona}, function(e){
					swal(
...
function activar(idpersona)
{
	swal({
		    ...
		    if (isConfirm){
						$.post("../controladores/docentes.php?op=activar", {idpersona : idpersona}, function(e){
...
function eliminar(idpersona)
{
	swal({
	    ...
	    if (isConfirm){
				$.post("../controladores/docentes.php?op=eliminar", {idpersona : idpersona}, function(e){
					swal(
						'!!! Eliminado !!!',e,'success')
            tabla.ajax.reload();
    	});
