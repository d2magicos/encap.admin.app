...
function listar() {
    tabla = $('#tbllistado').dataTable({
        ...
        "ajax": {
            url: '../controladores/subcategoria.php?op=listar',
            type: "post",
            dataType: "json",
            error: function(e) {
...
function guardaryeditar(e) {
    ...
    $.ajax({
        url: "../controladores/subcategoria.php?op=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
function mostrar(idcategoria) {
    $.post("../controladores/subcategoria.php?op=mostrar", { idcategoria: idcategoria }, function(data, status) {
...
function desactivar(idcategoria) {
    swal({
        ...
        if (isConfirm) {
            $.post("../controladores/subcategoria.php?op=desactivar", { idcategoria: idcategoria }, function(e) {
                swal(
...
function activar(idcategoria) {
    swal({
        ...
        if (isConfirm) {
            $.post("../controladores/subcategoria.php?op=activar", { idcategoria: idcategoria }, function(e) {
...
function eliminar(idcategoria) {
    swal({
        ...
        if (isConfirm) {
            $.post("../controladores/subcategoria.php?op=eliminar", { idcategoria: idcategoria }, function(e) {
                swal(
                    '!!! Eliminado !!!', e, 'success')
                tabla.ajax.reload();
            });
