  ...
  <div class="content-wrapper">
        ...
        <div class="panel-heading">
          <div class="box-header with-border" >
              <h1 class="box-title">Administrar nuestros docentes</h1>
          </div> 
        </div>

      <div class="panel-body table-responsive" class="box-body" id="listadoregistros">
        <button class="btn btn-primary" data-toggle="modal" data-target="#myModal" style="font-size:16px"><i class="fa fa-plus"> Crear Nuevo docente</i>
        </button>&nbsp&nbsp
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" role="form" name="formulario" id="formulario" method="POST">
        ...
        <div class="modal-header" style="background:#151e38; color:white">
          ...
          <h4 class="modal-title; text-center">Formulario del docentes</h4>
        </div>
        ...
        <div class="modal-body"> 
          ...
          <div class="form-group">                   
            ...
            <div class="col-sm-9"> 
              ...
              <input type="hidden" name="tipo_persona" id="tipo_persona" value="docentess">
