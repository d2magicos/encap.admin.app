...
$sQuery=mysqli_query($conexion, "SELECT *,p.nombre AS nombrep,p.num_documento AS numdoc,m.nota AS nota,c.contexto AS context,
c.nombre AS nombrec,c.idcategoria AS categoria,c.fecha_inicio AS fechac,c.docente AS docente,c.n_horas AS horas_old,m.horas AS horas,c.temario AS temario, m.año as año,
...
if($str>=50 and $str<=80){
    ...
    //  $pdf->MultiCell(220,15,utf8_decode($curso),1,'C');
