<?php
  ...
  //if ($dCerti["certificado"] == "") {   //  volver a SI 
    ...
    //  nuevo
    $imagen_fisio = $dCerti['imagenf'];
  
    //  caso especial
    $imagen_fisicosinfirma = './fpdf/img/DIPLOMAESPFISICOSINFIRMA.jpg';
    ...
    // nuevo
    if ($imprimir == "fisico") {
      $pdf->Image('./fpdf/img/'.$imagen_fisio, 0, 0, 297, 210);
    }
  
    // caso especial
    if ($imprimir == "fisico" && $dCerti["cod_matricula"] == '11115-41580455' || $dCerti["cod_matricula"] == '11170-43081802' || $dCerti["cod_matricula"] == '11185-41580455') {
      $pdf->Image($imagen_fisicosinfirma, 0, 0, 297, 210);
    }
    ...
    //  nuevo  
    if($imprimir == "fisico" || $imprimir == null) {
      $pdf->Image('./fpdf/img/'.$imagenpostbg, 0, 0, 297, 210);
    }
