...
$sQuery=mysqli_query($conexion, "SELECT *,p.nombre AS nombrep,p.num_documento AS numdoc,c.docente,m.contexto AS context,
c.nombre AS nombrec,m.fecha_inicio AS fechac,c.docente AS docente,c.n_horas AS horas,c.temario AS temario, m.año as año FROM matricula m 
...
$pdf->Image('./fpdf/img/UCAYALI B.jpg',0,0,297,210);
$pdf->SetFont("Times","",20);
