...
Class Compra
{
	...
	public function editar($idreclamo,$fecha,$descripcion,$fechaatencion,$hora,$solucion,$prioridad,$estado,$observaciones)
	{
	 	$sql="UPDATE gestionreclamos SET fecha='$fecha',descripcion='$descripcion',fechaatencion='$fechaatencion',hora= '$hora',solucion='$solucion',prioridad='$prioridad',estado='$estado',observaciones='$observaciones',condicion='1' WHERE idreclamo='$idreclamo'";
	 	return ejecutarConsulta($sql);
	}
	...
	public function listar()
	{
		...
		m.cod_matricula,c.nombre, categoria.nombre as categoria,m.fecha_inicio,gr.fechaatencion,sb.nombre as subasunto,gr.hora,gr.hora_reclamo,
