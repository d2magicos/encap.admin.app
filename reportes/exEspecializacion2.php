...
<tr >
        <td >
          ...
          <p style="padding: 15px 15px 15px 15px; border: 2px solid #060606; width: 930px;  text-align:left; font-size:17px;"> <?php echo str_replace("\n", "<br>", $regv->temario)?></p>
...
<div align="left" style="padding:60px 0px 8px 20px; position:absolute;  " id="qrcode"></div>
