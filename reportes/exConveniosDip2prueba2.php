...
<br><br><br>
<div align="center" style="padding:0px 0px 0px 145px; position:absolute; ">
...
<table border="0" align="center" width="100%" >
    ...
    <tr>
      <td align="center" style="font-family:Oswald; font-size:40px; text-decoration:underline; padding:0px 0px 0px 0px;   ">
    ...
    <div style="padding: 70px 0px 0px 60px;position: absolute;">
    <center>
...
<tr >
        <td >
          ...
          <p style="padding: 15px 15px 15px 15px; border: 2px solid #060606; width: 930px;  text-align:left; font-size:11.7px;"> <?php echo str_replace("\n", "<br>", $regv->temario)?></p>
           <p style="font-size: 14px;font-weight: bold;margin-left: -50px;"><?php echo $regv->docente; ?> </p>
...
<!-- <table style="position: absolute;padding:0px 0px 0px 0px;">
...
<div style="padding: 95px 0px 0px 770px; position:absolute;" >
...
<table border="0" align="left" style="padding:0px 0px 8px 30px">
  ...
  <div align="center" style="padding:45px 0px 50px 500px; position:absolute; ">
  <br>
  <img  src="../files/sellosencap.png "  style="width: 120px; height:120px">
    ...
    <tr>
        <td align="left" style=" font-size:15px; padding:195px 0px 0px 0px">
