...
function addClientAdresse( $cliente)
{
	...
	$this->MultiCell( 60, 10, "Otorgado a:",'C');
	$this->SetXY( $r1-73, $y1+17);
	$this->SetFont( "Arial", "B", 21);
	$this->MultiCell( 200, 0, $cliente,'C');
}

// Curso address
function addCursoAdresse($nombre)
{
	$r1     = $this->w - 120;
	$r2     = $r1 + 68;
	$y1     = 58;
	$this->SetXY( $r1-21, $y1);
	$this->SetFont( "Arial", "",18);
	$this->MultiCell( 100, 6, "En calidad de participante");
	$this->SetXY( $r1-50, 65);
	$this->SetFont( "Arial", "", 18);
	$this->MultiCell( 150, 6, utf8_decode("durante 60 horas académicas, en el curso de:"));
	$this->SetXY( $r1-65, $y1+9);
	$this->SetFont( "Arial", "B", 18);
	$this->MultiCell( 150, 10, $nombre,'C');

}

function addFechaAdresse($fecha_inicio)
{
	$r1     = $this->w - 120;
	$r2     = $r1 + 68;
	$y1     = 68;
	$this->SetXY( $r1-60, $y1+20);
	$this->SetFont( "Arial", "", 20);
	$this->MultiCell( 300, 10, utf8_decode($fecha_inicio.", organizado por"));
	$this->SetXY( $r1-50, $y1+40);
	$this->SetFont( "Arial", "", 20);
	$this->MultiCell( 200, 6, utf8_decode("la Escuela Nacional de Capacitación y Actualización Profesional"));

}

// PARTICIPANTE address MPAGE 2
function addPartAdresse( $cliente)
{
	$r1     = $this->w -120;
	$r2     = $r1 + 68;
	$y1     = 150;
	...
	$this->MultiCell( 60, 10, "Participante:");
	$this->SetXY( 155, 80);
	$this->SetFont( "Arial", "B", 18);
	$this->MultiCell( 500, 10, $cliente);
}
...
function temporaire($texte)
{
	//$this->Image($fondo , 0 ,0, 100, 100 , $ext_logo);
	$this->SetFont('Arial','B',50);
	$this->SetTextColor(203,203,203);
	$this->Rotate(0,0,0);
	$this->Text(10,70,$texte);
	$this->Rotate(0);
