...
<table border="0" align="center" width="100%" style="padding:0px 85px 0px 0px;" >
    ...
    <tr>
        <!-- Mostramos los datos del cliente en el documento HTML -->
        <td align="center" style="font-family:Oswald;  " >
        <strong ><b><?php $str =strlen($regv->nombre) ;
           ...
           if($str>=50 and $str<=80){
            ...
            echo "<p style=' padding: 5px 140px 5px 120px;  font-size:40px;line-height : 50px;'><font color='".$color."' >".$cadena."</font></p>"; 
          ...
          if($str>=81 ){
            ...
            $cadena = $regv->nombre;
            $color = "#000000"; //lo mismo que antes
            echo "<p style=' padding: 5px 160px 5px 120px;  font-size:30px;line-height : 32px;'><font color='".$color."' >".$cadena."</font></p>"; 
          ...
          if($str<=49){
            ...
            $cadena = $regv->nombre;
            $color = "#000000"; //lo mismo que antes
            echo "<p style='font-size:50px;line-height : 60px; padding: 4px 140px 4px 120px; '><font color='".$color."' >".$cadena."</font></p>"; 
          };
