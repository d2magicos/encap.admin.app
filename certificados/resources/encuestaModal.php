      ...
      <div class="modal-body" id="modal-body">
        ...
        <div class="survey-container" id="survey-container">
          <div class="satisfaction-survey" id="satisfaction-survey">
            ...
            <h5 class="text-center pt-3 pb-2 px-2" style="font-size: 16px; font-weight: 600;">¿Cuál fue tu experiencia con ENCAP?</h5>
            ...
            <form action="post" id="surveyForm">
              ...
              <div class="pt-2">
                <textarea name="comment" id="comment" class="w-100 mt-3 mb-2" rows="4"
                  placeholder="Tu opinión nos importa, déjanos un comentario..."></textarea>
              </div>
