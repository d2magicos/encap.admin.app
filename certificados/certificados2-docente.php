...
<?php
    ...
    if ($doc != null) {
        /* Get student */
        $resultadop = mysqli_query($conexion, "SELECT p.nombre, p.num_documento, p.departamento, p.ciudad, p.email, m.idcurso, c.nombre as curso, c.fecha_inicio as fecha, c.contexto, cat.nombre as categoria, m.cod_matricula, m.idplantilla, m.certificado, m.estadosatisfacion
                                               FROM persona p 
    ...
    <header class="header">
        <div class="container header-container">
            <nav class="main-menu">
                ...
                <ul>
                    <li class="actived"><a href="./certificados2-docente.php?docente=<?= $prof; ?>">Inicio</a></li>
